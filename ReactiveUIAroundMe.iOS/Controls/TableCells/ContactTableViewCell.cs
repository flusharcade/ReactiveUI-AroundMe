// --------------------------------------------------------------------------------------------------
//  <copyright file="ContactTableViewCell.cs" company="Flush Arcade.">
...
namespace ReactiveUIAroundMe.iOS.Controls
{
	...
	/// </summary>
	public partial class ContactTableViewCell : BaseTableViewCell, IViewFor<ContactListItemViewModel>
	{
		/// <summary>
		/// The key.
		/// </summary>
		...
		/// The view model.
		/// </summary>
		private ContactListItemViewModel _viewModel;

		/// <summary>
		/// Gets or sets the view model.
		/// </summary>
		/// <value>The view model.</value>
		public ContactListItemViewModel ViewModel
		{
		...
		object IViewFor.ViewModel
		{
			...
			set { ViewModel = value as ContactListItemViewModel; }
		}
		...
		public override void Initialize()
		{
			...
			ViewModel.WhenAnyValue(x => x.Icon)
				 .Select(file => UIImage.FromFile(file))
				 .BindTo(this, x => x._iconImageView.Image);
		}
	}
}
