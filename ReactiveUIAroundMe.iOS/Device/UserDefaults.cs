...
namespace ReactiveUIAroundMe.iOS.Device
{
    ...
    public class UserDefaults : IUserDefaults
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="MyCareManager.iOS.Device.UserDefaults"/> is authenticated.
        /// </summary>
        ...
        public string Host
        {
            get
            {
                return _settings.GetValueOrDefault("Host", Config.BaseUrl);
            }
            set
            {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:ICC.iOS.Device.UserDefaults"/> class.
        /// </summary>
