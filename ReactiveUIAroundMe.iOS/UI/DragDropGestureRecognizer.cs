	...
	public class DragDropGestureRecognizer : UIGestureRecognizer
	{
...
#endif
				OnHeld(this, new DragDropEventArgs(default(UIGestureRecognizerState), DragAt, Delta, ViewWasAt, DownAt));
		...
		public override void TouchesEnded(NSSet touches, UIEvent evt)
		{
			...
			if (DidDrag)
			{
				...
				OnDropped(this, new DragDropEventArgs(State, DragAt, Delta, ViewWasAt, DownAt));
			}
			else
			{
				State = UIGestureRecognizerState.Failed;
		...
		public override void TouchesMoved(NSSet touches, UIEvent evt)
		{
			...
			if (DidLongPress)
			{
				...
				{
					DidDrag = true;
					OnDragging(this, new DragDropEventArgs(State, DragAt, Delta, ViewWasAt, DownAt));
					State = UIGestureRecognizerState.Changed;
				}
			}
