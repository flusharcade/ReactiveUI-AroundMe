// --------------------------------------------------------------------------------------------------
//  <copyright file="SearchResultViewModel.cs" company="Flush Arcade Pty Ltd.">
...
namespace ReactiveUIAroundMe.Portable.ViewModels
{
	...
	/// Tile view model.
	/// </summary>
	public class SearchResultViewModel : TetrixViewModelBase
	{
		#region Bindable
		...
		public SearchResultViewModel(ISQLiteStorage storage, IScheduler scheduler, ILogger log,
