// --------------------------------------------------------------------------------------------------
//  <copyright file="EReactiveUIAroundMeListItemViewModel.cs" company="Flush Arcade Pty Ltd.">
...
namespace ReactiveUIAroundMe.Portable.ViewModels
{
	...
	/// <summary>
	/// EReactiveUIAroundMe list item view model.
	/// </summary>
	public class EReactiveUIAroundMeListItemViewModel : TetrixViewModelBase
	{
		#region Bindable
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="T:ReactiveUIAroundMe.Portable.ViewModels.EReactiveUIAroundMeListItemViewModel"/>
		...
		/// <summary>
		/// Gets the distance display.
		/// </summary>
		/// <value>The distance display.</value>
		public string DistanceDisplay
		{
			get 
			{
				return string.Format("{0} kms", Distance);
			}
		}
		...
		public EReactiveUIAroundMeListItemViewModel(ISQLiteStorage storage, IScheduler scheduler, ILogger log,
