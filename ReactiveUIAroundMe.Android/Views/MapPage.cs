...
//	/// Search results page.
//	/// </summary>
//	public class MapPage : BaseMvxViewController, IViewFor<MapPageViewModel>
//	{
//		#region Constants
...
//				NSLayoutConstraint.FromVisualFormat("V:|[directionTopView(35)][directionBottomView]|", NSLayoutFormatOptions.DirectionLeftToRight, null, directionViews)
...
//				.Concat(NSLayoutConstraint.FromVisualFormat("V:|-7-[directionTopVerticalSeperator]-10-|", NSLayoutFormatOptions.DirectionLeftToRight, null, directionTopViews))
...
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[directionButton(30)]-5-[carButton(20)]-10-[busButton(carButton)]-10-[walkButton(carButton)]-10-[directionTopVerticalSeperator(1)]", NSLayoutFormatOptions.AlignAllTop, null, directionTopViews))
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:[favouriteButton(20)]-8-[shareButton(18)]-5-|", NSLayoutFormatOptions.AlignAllTop, null, directionTopViews))
...
//				{
//					case 0:
//						_contactView.Hidden = false;
//						_feedbackView.Hidden = true;
//					break;
//					case 1:
//						_contactView.Hidden = true;
//						_feedbackView.Hidden = false;
//					break;
//				}
//			} ;

//			_contactView = new UIView()
//			{
//				TranslatesAutoresizingMaskIntoConstraints = false,
//			};
...
//			var _phoneTitleLabel = new UILabel()
//			{
//				TranslatesAutoresizingMaskIntoConstraints = false,
...
//			var _emailTitleLabel = new UILabel()
//			{
//				TranslatesAutoresizingMaskIntoConstraints = false,
//				Font = UIFont.FromName("Arial", 10f),
//				TextAlignment = UITextAlignment.Left,
...
//			var _websiteTitleLabel = new UILabel()
//			{
//				TranslatesAutoresizingMaskIntoConstraints = false,
//				Font = UIFont.FromName("Arial", 10f),
//				TextAlignment = UITextAlignment.Left,
...
//			_contactView.Add(_phoneTitleLabel);
//			_contactView.Add(_phoneLabel);
//			_contactView.Add(_emailTitleLabel);
//			_contactView.Add(_emailLabel);
//			_contactView.Add(_websiteTitleLabel);
//			_contactView.Add(_websiteLabel);

//			var contactViews = new DictionaryViews()
//			{
//				{"phoneTitleLabel", _phoneTitleLabel},
//				{"phoneLabel", _phoneLabel},
//				{"emailTitleLabel", _emailTitleLabel},
//				{"emailLabel", _emailLabel},
//				{"websiteTitleLabel", _websiteTitleLabel},
//				{"websiteLabel", _websiteLabel},
//			};

//			_contactView.AddConstraints(
//				NSLayoutConstraint.FromVisualFormat("V:|[phoneTitleLabel][emailTitleLabel][websiteTitleLabel]|", NSLayoutFormatOptions.DirectionLeftToRight, null, contactViews)
//				.Concat(NSLayoutConstraint.FromVisualFormat("V:|[phoneLabel][emailLabel][websiteLabel]|", NSLayoutFormatOptions.DirectionLeftToRight, null, contactViews))
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[phoneTitleLabel]|", NSLayoutFormatOptions.AlignAllTop, null, contactViews))
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[emailTitleLabel]|", NSLayoutFormatOptions.AlignAllTop, null, contactViews))
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[websiteTitleLabel]|", NSLayoutFormatOptions.AlignAllTop, null, contactViews))
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[phoneLabel]|", NSLayoutFormatOptions.AlignAllTop, null, contactViews))
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[emailLabel]|", NSLayoutFormatOptions.AlignAllTop, null, contactViews))
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[websiteLabel]|", NSLayoutFormatOptions.AlignAllTop, null, contactViews))
//				.ToArray());
...
//			View.AddConstraints(
//				NSLayoutConstraint.FromVisualFormat("V:|[mapView][infoView]|", NSLayoutFormatOptions.DirectionLeftToRight, null, views)
//				// map view is a bit smaller than info view
//				.Concat(new NSLayoutConstraint[] { NSLayoutConstraint.Create(_mapView, NSLayoutAttribute.Height, NSLayoutRelation.Equal, infoView, NSLayoutAttribute.Height, 0.7f, 0) })
...
//				.Concat(new NSLayoutConstraint[] { NSLayoutConstraint.Create(directionView, NSLayoutAttribute.Height, NSLayoutRelation.Equal, _mapView, NSLayoutAttribute.Height, 0.4f, 0) })
...
//				NSLayoutConstraint.FromVisualFormat("V:|[segmentControl(35)][contactView]|", NSLayoutFormatOptions.DirectionLeftToRight, null, infoViews)	
...
//				.Concat(NSLayoutConstraint.FromVisualFormat("H:|[contactView]|", NSLayoutFormatOptions.AlignAllTop, null, infoViews))
...
//			this.BindCommand(ViewModel, x => x.TransitCommand, x => x._buttons[1]);
//			this.BindCommand(ViewModel, x => x.DrivingCommand, x => x._buttons[2]);
...
//						double latDif = pathArgs.StartCoordinate.Latitude - pathArgs.EndCoordinate.Latitude;
//						double lonDif = pathArgs.StartCoordinate.Longitude - pathArgs.EndCoordinate.Longitude;
//						double midLat = latDif / 2 + pathArgs.StartCoordinate.Latitude;
//						double midLon = lonDif / 2 + pathArgs.StartCoordinate.Longitude;
